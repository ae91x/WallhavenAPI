...
namespace WallhavenAPI.Structs
{
    public class Query
    {
        #region Enums
        ...
        static string[] AvailableRatios = new string[] {
            "4x3"
            , "5x4"
            , "16x9"
            , "16x10"
        ...
        static string[] AvailableRanges = new string[] {
            "1d"
            , "3d"
            , "1w"
            , "1M"
        ...
        static string[] AvailableColors = new string[] {
            "660000"
            , "990000"
            , "cc0000"
            , "cc3333"
